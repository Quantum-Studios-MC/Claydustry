...
This repository contains the source and configuration for the **Claydustry**
modpack.  It is built from metadata files and packaged using the same
template tools as QSMCTemplate.  See the original template project for
